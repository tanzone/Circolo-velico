...
public class Main extends Application {
    ...
    public void start(Stage stage) {
        Utilities.loadScene(stage, "signInUp_screen", "SignInUp", SignInUpController.class);
        stage.getIcons().add(new Image(Objects.requireNonNull(SignInUpController.class.getResourceAsStream("boat.png"))));
